...
# Criar uma lista contendo todos os e-mails e exibir.
print("\n")
# Iterador para extrair os e-mails dos usuários
emails = [] #incializa a lista de e-mails
for user in users:
...
# Mostrar a penas o primeiro nome de todos os usuários
print("\n")
...
# Mostar quantos usuários existem na lista
print("\n")
